...
## Install
- First switch to root user then proceed
```
pip install aws-tagger
```
- If getting some kind of error while running the above command then update the pip and setuptools and then proceed for aws-tagger installation
```
